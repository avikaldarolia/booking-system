...
const CustomerLogin: React.FC = () => {
	...
	return (
		<div className="max-w-md w-4/5 mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
				...
				<div>
					...
					<div className="my-2 relative rounded-md shadow-sm">
						...
						<input
							...
							type="email"
							required
							className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 sm:text-sm border-gray-300 rounded-md"
